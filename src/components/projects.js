...
export const Projects = () => {
    ...
    {id:1, name: "Jars", photo:'/project-imgs/katt-yukawa-K0E6E0a0R3A-unsplash.jpg',link:""},
    {id:2,name: "Truth", photo:'/project-imgs/bible-unsplash.jpg',link:""},
    { id: 3, name: "Not Alone", photo: '/project-imgs/hannah-busing-Zyx1bK9mqmA-unsplash.jpg', link:"https://fight-loneliness.com/"}
    ];
